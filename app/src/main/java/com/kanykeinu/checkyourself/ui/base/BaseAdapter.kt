...
import com.kanykeinu.checkyourself.extensions.ViewContainer
import java.io.File
...
//    }
    ...
    class BaseHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView) , ViewContainer{
    }
